...
2. Implement quote iteration, so the completion of one quote leads to either the presentation of the next quote or, after the last quote, the presentation of the results page.
